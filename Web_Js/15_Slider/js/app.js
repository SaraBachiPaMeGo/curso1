import ARBOLES from './imegenes.json.js' // Cuando se importa algo por defecto puedes ponerle cualquier nombre como ARBOLES
export function app() {
    ...
    aImgWrapper.forEach((item,i) => item.appendChild(aImagenes[i]))
